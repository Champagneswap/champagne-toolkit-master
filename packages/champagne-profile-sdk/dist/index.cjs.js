...
var profileABI = [
	{
		inputs: [
			...
			{
				internalType: "uint256",
				name: "_numberChamToReactivate",
				type: "uint256"
			},
			{
				internalType: "uint256",
				name: "_numberChamToRegister",
				type: "uint256"
			},
			{
				internalType: "uint256",
				name: "_numberChamToUpdate",
				type: "uint256"
			}
		],
		stateMutability: "nonpayable",
	...
	},
	{
		inputs: [
			{
				internalType: "uint256",
				name: "_newNumberChamToReactivate",
				type: "uint256"
			},
			{
				internalType: "uint256",
				name: "_newNumberChamToRegister",
				type: "uint256"
			},
			{
				internalType: "uint256",
				name: "_newNumberChamToUpdate",
				type: "uint256"
			}
		],
		name: "updateNumberCham",
		outputs: [
		],
		stateMutability: "nonpayable",
		type: "function"
...
var getChampagneProfileAddress = function (chainId) {
    return addresses.champagneProfile[chainId];
};
...
var getProfileContract = function (provider, chainId) {
    return getContract(profileABI, getChampagneProfileAddress(chainId), provider);
};

var profileApi = "https://profile.champagneswap.com";
var profileSubgraphApi = "https://api.thegraph.com/subgraphs/name/champagneswap/profile";
...
(function (NftType) {
    NftType["CHAMPAGNE"] = "champagne";
    NftType["MIXIE"] = "mixie";
})(exports.NftType || (exports.NftType = {}));

var _a;
var nftSources = (_a = {},
    _a[exports.NftType.CHAMPAGNE] = {
        address: {
...
var Nfts = [
    ...
    },
    {
        ...
        type: exports.NftType.CHAMPAGNE,
        variationId: 15,
    },
    {
...
/**
 * Some sources like champagne do not return HTTP tokenURI's
 */
...
var ChampagneProfileSdk = /** @class */ (function () {
    function ChampagneProfileSdk(args) {
        var _this = this;
         ...
         * API repo - https://github.com/Champagneswap/Champagne-profile-api
         */
         ...
         * Contract repo - https://github.com/Champagneswap/Champagne-contracts/tree/master/projects/profile-nft-gamification
         */
         ...
         * from ChampagneProfile contract.
         * NFT's bunnyId is retrieved from ChampagneSprayers contract and mapped to static NFT data stored in constant.
         * Contracts repo - https://github.com/Champagneswap/Champagne-contracts/tree/master/projects/profile-nft-gamification
         */
        this.getProfile = function (address) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        nft = _b.sent();
                        avatar = nft ? "https://champagneswap.com/images/nfts/" + nft.images.sm : undefined;
                        // Save the preview image in a cookie so it can be used on the exchange
                        // TODO v2: optional (and configurable) Cookies.set
                        js_cookie.set("profile_" + address, {
                            username: username,
                            avatar: avatar,
                        }, { domain: "champagneswap.com", secure: true, expires: 30 });
                        _b.label = 6;
                    case 6:
                        profile = {
                            userId: userId,
...
exports.default = ChampagneProfileSdk;

...
describe("ChampagneProfileSdk", () => {
  describe("constructor", () => {
    ...
    it("uses custom provider instance if specified", () => {
      ...
      const sdk = new ChampagneProfileSdk({ provider: customProvider });
      expect(sdk.provider).toBe(customProvider);
    });
    it("uses specific chainId if chainId is provided", () => {
      const sdk = new ChampagneProfileSdk({ chainId: TESTNET_CHAIN_ID });
    ...
    describe("getProfile", () => {
      ...
      it("sets cookies", async () => {
        ...
        expect(Cookies.set).toBeCalledWith(
          ...
          {
            username: "Cheems",
            avatar: `https://champagneswap.com/images/nfts/${sleepyNft.images.sm}`,
          },

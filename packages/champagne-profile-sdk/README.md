...
Install `@champagneswap/profile-sdk` into your project with npm:

```bash
npm install @champagneswap/profile-sdk --save
```

or yarn:

```bash
yarn add @champagneswap/profile-sdk
```
...
```js
import ChampagneProfileSdk from "@champagneswap/profile-sdk";

const champagneSdk = new ChampagneProfileSdk();
```
...
const champagneSdk = new ChampagneProfileSdk(customProvider, 97);
```
...
const champagneSdk = new ChampagneProfileSdk();
const username = champagneSdk.getUsername("0x123456789");
...
const champagneSdk = new ChampagneProfileSdk();
const team = champagneSdk.getTeam(1);
console.log(team);
// {
//   id: 1,
//   name: "Syrup Storm",
...
const champagneSdk = new ChampagneProfileSdk();
const profile = champagneSdk.getProfile("0x123456789");
console.log(profile);
// {
//   hasRegistered: true
//   profile: {
...
const achievements = champagneSdk.getAchievements("0x123456789");
...
```JSX
import { Team, teamImages } from "@champagneswap/profile-sdk";

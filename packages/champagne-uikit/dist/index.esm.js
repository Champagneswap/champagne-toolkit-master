...
var ChamPrice = function (_a) {
    ...
    return chamPriceUsd ? (React__default.createElement(PriceLink, { href: "https://champagneswap.com/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", target: "_blank" },
        React__default.createElement(Icon$1h, { width: "24px", mr: "8px" }),
        React__default.createElement(Text, { color: color, bold: true }, "$" + chamPriceUsd.toFixed(3)))) : (React__default.createElement(Skeleton, { width: 80, height: 24 }));
};
var ChamPrice$1 = React__default.memo(ChamPrice);
...
var ChampagneToggle = function (_a) {
    ...
    return (React__default.createElement(ChampagneStack, { scale: scale },
        React__default.createElement(ChampagneInput, __assign({ id: props.id || "champagne-toggle", scale: scale, type: "checkbox", checked: checked }, props)),
        React__default.createElement(ChampagneLabel, { scale: scale, checked: checked, htmlFor: props.id || "champagne-toggle" },
...
var RotatingChampagneIcon = styled(Icon)(templateObject_4$6 || (templateObject_4$6 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
var FloatingChamIcon = styled(Icon$1)(templateObject_5$4 || (templateObject_5$4 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var Spinner = function (_a) {
    var _b = _a.size, size = _b === void 0 ? 128 : _b;
    return (React__default.createElement(Container, null,
        React__default.createElement(RotatingChampagneIcon, { width: size * 0.5 + "px" }),
        React__default.createElement(FloatingChamIcon, { width: size + "px" })));
};
        ...
        React__default.createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            ...
            React__default.createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                ...
                React__default.createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default.createElement(Button, { as: "a", href: "https://pancakeswap.finance/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", target: "_blank", scale: "sm", endIcon: React__default.createElement(Icon$29, { color: lightColors.backgroundAlt }) }, buyChamLabel))))));
};
...
var Logo = function (_a) {
    ...
    return (React__default.createElement(Flex, null, isAbsoluteUrl ? (React__default.createElement(StyledLink, { as: "a", href: href, "aria-label": "Champagne home page" }, innerLogo)) : (React__default.createElement(StyledLink, { href: href, as: linkComponent, "aria-label": "Champagne home page" }, innerLogo))));
};
        ...
        React__default.createElement(Wrapper, null,
                ...
                React__default.createElement(StyledNav, null,
                    ...
                    React__default.createElement(Flex, { alignItems: "center", height: "100%" },
                        !isMobile && (React__default.createElement(Box, { mr: "12px" },
                            React__default.createElement(ChamPrice$1, { chamPriceUsd: chamPriceUsd }))),
            ...
            React__default.createElement(BodyWrapper, { mt: !subLinks ? totalTopMenuHeight + 1 + "px" : "0" },
                React__default.createElement(Inner, { isPushed: false, showMenu: showMenu },
                    children,
                    React__default.createElement(MenuItem, { items: footerLinks, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, chamPriceUsd: chamPriceUsd, buyChamLabel: buyChamLabel, mb: [MOBILE_MENU_HEIGHT + "px", null, "0px"] }))),
    ...
    return (React__default.createElement(ModalContainer, { minWidth: "320px" },
        ...
        React__default.createElement(ModalBody, { width: ["320px", null, "340px"] },
            ...
            React__default.createElement(Box, { p: "24px" },
                ...
                React__default.createElement(Button, __assign({ as: "a", href: "https://docs.champagneswap.com/get-started/connection-guide", variant: "subtle", width: "100%" }, getExternalLinkProps()), t("Learn How to Connect"))))));
};
